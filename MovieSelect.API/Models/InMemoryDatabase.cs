namespace MovieSelect.API.Models
{
        ...
        public static List<Movie> Movies { get; set; } = new List<Movie>
    {
        ...
        new Movie { Id = 13, Title = "Mad Max: Fury Road", AgeRating = "R", GenreId = 1 },
        new Movie { Id = 14, Title = "The Hangover", AgeRating = "R", GenreId = 2 },
        new Movie { Id = 15, Title = "The Shawshank Redemption", AgeRating = "R", GenreId = 3 },
        new Movie { Id = 16, Title = "Forrest Gump", AgeRating = "PG-13", GenreId = 3 },
        new Movie { Id = 17, Title = "A Quiet Place", AgeRating = "PG-13", GenreId = 4 },
        new Movie { Id = 18, Title = "The Matrix", AgeRating = "R", GenreId = 5 },
        new Movie { Id = 19, Title = "The Notebook", AgeRating = "PG-13", GenreId = 6 },
        new Movie { Id = 20, Title = "La La Land", AgeRating = "PG-13", GenreId = 6 },
        new Movie { Id = 21, Title = "Big Hero 6", AgeRating = "G", GenreId = 7 },
        new Movie { Id = 22, Title = "Frozen", AgeRating = "PG", GenreId = 7 },
        new Movie { Id = 23, Title = "Gladiator", AgeRating = "R", GenreId = 1 },
        new Movie { Id = 24, Title = "Step Brothers", AgeRating = "R", GenreId = 2 },
        new Movie { Id = 25, Title = "Shrek", AgeRating ="G", GenreId = 7}
